...
// Three Bugs
//errors found
//1. array[i] = calculateSTI(array) to array[i] = calculateSTI(array[i]);
//2. newArray[2] = baseSalary * (1.0 + bonus) to newArray[2] = Math.round(baseSalary * (1.0 + bonus))
...
for(var i = 0; i < array.length; i++){
	array[i] = calculateSTI(array[i]);// error here in old
 	newEl = document.createElement('li');
	newText = document.createTextNode(array[i].join(", "));// added array.join
